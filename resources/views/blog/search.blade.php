...
<section id="news-feed" class="news-feed-section">
  <div class="container">
  @if (request()->input('q'))
    <h6 style="margin-bottom: 50px ;">{{ $post->total() }} résultat(s) pour la recherche "{{ request()->q }}"</h6>
  @endif
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="saasio-blog-text">
                    <h3><a href="{{ route('blog.show', $post[$i]->slug) }}#">{{$post[$i]->translate(session("lang"),"en")->title}}</a></h3>

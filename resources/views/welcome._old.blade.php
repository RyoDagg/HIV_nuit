...
<body class="app-edu" data-spy="scroll" data-target=".app-edu-main-navigation" data-offset="80">
        ...
        <div class="container">
            <div class="app-edu-banner-content position-relative">
                <div class="app-edu-banner-text app-edu-headline pera-content wow fadeFromLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <a class="banner-btn text-center show-modal" href="#" data-toggle="modal" data-target="#myModal">Take Quizz</a>
                </div>
    ...
    <!-- Start of course section
        ============================================= -->
    <section id="app-edu-course" class="app-edu-course-section" hidden>
        <div class="container">
    ...
    <!-- Start of category section
        ============================================= -->
    <section id="app-edu-category" class="app-edu-category-section" data-background="img/education/ct-bg.jpg" hidden>
        <div class="container">
            <div class="app-edu-section-title app-edu-headline text-center center-align pera-content">
                <span>Learn anything you want</span>
                    ...
                    <div class="containerDegla">
                        ...
                        <form class="quiz">
                            <div class="quiz__inner">
                                <div data-question="1" class="quiz_step--1 quizstep--current quiz_step">
                                ...
                                <div data-question="2" class="quiz_step--2 quiz_step">
                                    <div class="question__emoji">🚬 </div>
                                    <h1 class="quiz__question">Do you smoke cigarettes?</h1>
                                    <div class="answer">
                                        <input data-char="65" class="answer__input" type="radio" id="smoke_yes2" name="smoke2" value="Yes">
                                        <label class="answer__label" for="smoke_yes2">Yes</label>
                                    </div>
                                    <div class="answer">
                                        <input data-char="66" class="answer__input" type="radio" id="smoke_no2" name="smoke2" value="No">
                                        <label class="answer__label" for="smoke_no2">No</label>
                                    </div>
                                </div>
                                <div data-question="3" class="quiz_step--3 quiz_step">
                                    <div class="question__emoji">
                                        <p> &#x231A;</p>
                                    </div>
                                    ...
                                    <div class="answer">
                                        ...
                                        <label class="answer_label" for="pizza_no">No<div class="answer_tick">
                                ...
                                <div data-question="4" class="quiz_step--4 quiz_step">
                                    <div class="question__emoji">
                                        <p> &#x231A;</p>
                                    </div>
                                    <h1 class="quiz__question">Do you like pizza?</h1>
                                    <div class="answer">
                                        <input class="answer__input" type="radio" id="pizza_yes4" name="pizza4" value="Yes">
                                        <label class="answer__label" for="pizza_yes4">Yes</label>
                                    </div>
                                    <div class="answer">
                                        <input class="answer__input" type="radio" id="pizza_no4" name="pizza4" value="No">
                                        <label class="answer_label" for="pizza_no4">No<div class="answer_tick">
                                                <svg width="14" height="14" viewBox="0 0 24 24">
                                                    <path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z"></path>
                                                </svg>
                                            </div></label>
                                ...
                                <div data-question="5" class="quiz_step--5 quizstep quiz_summary">
